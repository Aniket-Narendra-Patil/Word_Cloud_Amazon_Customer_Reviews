...
Important guideline: Each application folder has a juypter notebook file (code), .csv file (sample dataset) and a readme file regarding that application.
To run any application, make sure to import all files in the application folder.
